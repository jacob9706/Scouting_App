...
public class NumberPickerCustom extends RelativeLayout {
	 ...
	 */
	public NumberPickerCustom( Context context, boolean vertical, int btnW, int btnH, int txtW, int txtH) {
		super(context);
			...
			public void onFocusChange( View v, boolean hasFocus) {
				if (hasFocus) {
					...
					try {
						...
						if (mVCListener != null) {
							mVCListener.onNumberPickerValueChange(NumberPickerCustom.this, mCurVal);
						}
	...
	public interface ValueChangeListener {
		public void onNumberPickerValueChange( NumberPickerCustom picker, int value);
	}
